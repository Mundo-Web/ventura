                            ...
                            <div class="rounded shadow-lg p-4 px-4 w-full">
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="title1section">Titulo - Nosotros</label>
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="description1section">Descripción - Nosotros</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="description1section" name="description1section"
                                                value="{{ $nosotros->description1section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="imagen">Nueva imagen principal (1120x570 px)</label>
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="subtitle3section">Subtitulo - Misión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="subtitle3section" name="subtitle3section"
                                                ...
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese subtitulo para mision">
                                        </div>
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="title3section">Titulo - Misión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="description3section">Descripción - Misión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="description3section" name="description3section"
                                                value="{{ $nosotros->description3section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="subtitle3secondsection">Subtitulo - Visión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="subtitle3secondsection"
                                                name="subtitle3secondsection"
                                                value="{{ $nosotros->subtitle3secondsection }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese subtitulo para vision">
                                        </div>
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="title3secondsection">Titulo - Visión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="description3secondsection">Descripción - Visión</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="description3secondsection"
                                                name="description3secondsection"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="imagensecond">Imagen Estadisticas (442x638 px)</label>
                                        <div class="relative mb-2  mt-2">
